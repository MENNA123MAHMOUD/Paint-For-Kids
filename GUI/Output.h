...
public:
	...
	void DrawEllipse(Point P1, Point P2, GfxInfo EllipseGfxInfo, bool selected=false) const ;  //Draw a elipse
	void DrawPolygon(Point P1, Point P2 ,Point P3,Point P4, GfxInfo EllipseGfxInfo, bool selected=false) const ;
